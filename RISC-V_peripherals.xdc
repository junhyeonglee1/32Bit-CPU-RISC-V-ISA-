...
## Switches
 ...
 set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { GPIOC[4]  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
 set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { GPIOC[5]  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
 set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { GPIOC[6]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
 set_property -dict { PACKAGE_PIN W17  IOSTANDARD LVCMOS33 } [get_ports { GPIOC[7]  }]; #IO_L20N_T3_A07_D23_14      ,Sch=SW3
#set_property -dict { PACKAGE_PIN W15  IOSTANDARD LVCMOS33 } [get_ports {   }]; #IO_L21N_T3_DQS_A06_D22_14  ,Sch=SW4
#set_property -dict { PACKAGE_PIN V15  IOSTANDARD LVCMOS33 } [get_ports {   }]; #IO_L21P_T3_DQS_14          ,Sch=SW5
#set_property -dict { PACKAGE_PIN W14  IOSTANDARD LVCMOS33 } [get_ports {   }]; #IO_L22N_T3_A04_D20_14      ,Sch=SW6
#set_property -dict { PACKAGE_PIN W13  IOSTANDARD LVCMOS33 } [get_ports {   }]; #IO_L22P_T3_A05_D21_14      ,Sch=SW7
set_property -dict { PACKAGE_PIN V2   IOSTANDARD LVCMOS33 } [get_ports { GPIB[0]  }]; #IO_L5P_T0_34               ,Sch=SW8
set_property -dict { PACKAGE_PIN T3   IOSTANDARD LVCMOS33 } [get_ports { GPIB[1]  }]; #IO_L2N_T0_34               ,Sch=SW9
set_property -dict { PACKAGE_PIN T2   IOSTANDARD LVCMOS33 } [get_ports { GPIB[2] }]; #IO_L1N_T0_34               ,Sch=SW10
set_property -dict { PACKAGE_PIN R3   IOSTANDARD LVCMOS33 } [get_ports { GPIB[3] }]; #IO_L2P_T0_34               ,Sch=SW11
set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { GPIB[4] }]; #IO_L5N_T0_34               ,Sch=SW12
set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { GPIB[5] }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { GPIB[6]}]; #IO_L3P_T0_DQS_34           ,Sch=SW14
set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOS33 } [get_ports { GPIB[7] }]; #IO_L1P_T0_34               ,Sch=SW15


# LEDs

set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { GPIOC[0]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { GPIOC[1]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { GPIOC[2]  }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports { GPIOC[3]  }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 ,Sch=LED3
# set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { GPOC[4]  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
# set_property -dict { PACKAGE_PIN U15  IOSTANDARD LVCMOS33 } [get_ports { GPOC[5]  }]; #IO_L23P_T3_A03_D19_14        ,Sch=LED5
# set_property -dict { PACKAGE_PIN U14  IOSTANDARD LVCMOS33 } [get_ports { GPOC[6]  }]; #IO_25_14                     ,Sch=LED6
# set_property -dict { PACKAGE_PIN V14  IOSTANDARD LVCMOS33 } [get_ports { GPOC[7]  }]; #IO_L24N_T3_A00_D16_14        ,Sch=LED7
set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS33 } [get_ports { GPOA[0]  }]; #IO_L24P_T3_A01_D17_14        ,Sch=LED8
set_property -dict { PACKAGE_PIN V3   IOSTANDARD LVCMOS33 } [get_ports { GPOA[1] }]; #IO_L6P_T0_34                 ,Sch=LED9
set_property -dict { PACKAGE_PIN W3   IOSTANDARD LVCMOS33 } [get_ports { GPOA[2] }]; #IO_L6N_T0_VREF_34            ,Sch=LED10
set_property -dict { PACKAGE_PIN U3   IOSTANDARD LVCMOS33 } [get_ports { GPOA[3] }]; #IO_L9P_T1_DQS_34             ,Sch=LED11
set_property -dict { PACKAGE_PIN P3   IOSTANDARD LVCMOS33 } [get_ports { GPOA[4] }]; #IO_L12N_T1_MRCC_35           ,Sch=LED12
set_property -dict { PACKAGE_PIN N3   IOSTANDARD LVCMOS33 } [get_ports { GPOA[5]}]; #IO_L12P_T1_MRCC_35           ,Sch=LED13
set_property -dict { PACKAGE_PIN P1   IOSTANDARD LVCMOS33 } [get_ports { GPOA[6] }]; #IO_L19N_T3_VREF_35           ,Sch=LED14
set_property -dict { PACKAGE_PIN L1   IOSTANDARD LVCMOS33 } [get_ports { GPOA[7]}]; #IO_L6N_T0_VREF_35            ,Sch=LED15
...
set_property -dict { PACKAGE_PIN A14  IOSTANDARD LVCMOS33 } [get_ports { dht_signal }]; #IO_L6P_T0_16       ,Sch=JB1
